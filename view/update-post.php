	...
	<section id="car-pagination">
		<div class="content-holder">
			...
			<nav class="default-tabs split-tabs">
				<ul>
					<li class="current-item"><a href=""><span> Update</span></a></li>
				...
				<form action="/" method="post" enctype="multipart/form-data">
					<fieldset id="vehicle-data">
						...
						<ul class="field-content">
							<li class="select-four">
								<div>
									...
									<select name="manufacturer" id="select-manufacturer">
										<option selected="selected" disabled=""><?= $postForUpdate->car->brand?></option>
								...
								<div>
									...
									<select name="model" id="select-model">
										<option selected="selected"><?= $postForUpdate->car->model?></option>
									</select>
								</div>
								<div>
									<label for="select-euro-type">Euro type:<span class="mandatory">*</span></label>
									<select name="euroType" id="select-euro-type">
										<option selected="selected"><?= $postForUpdate->car->eurotype?></option>
								...
								<div>
									...
									<select name="bodyType" id="select-body-type">
										<option selected="selected"><?= $postForUpdate->car->bodytype?></option>
							...
							<li class="select-four">
								<div>
									<label for="select-fuel-type"><span class="mandatory">*</span></label>
									<select name="fuelType" id="select-fuel-type">
										<option selected="selected"><?= $postForUpdate->car->fueltype?></option>
								...
								<div>
									...
									<select name="transmission" id="select-transmission">
										<option selected="selected"><?= $postForUpdate->car->transmissiontype?></option>
								...
								<div>
									...
									<select name="doors" id="select-doors">
										<option selected="selected"><?= $postForUpdate->car->doors?></option>
								...
								<div>
									...
									<select name="color" id="select-color">
										<option selected="selected"><?= $postForUpdate->car->color?></option>
								...
								<li class="select-four">
									<div id="cilindricsDiv">
										...
										<input type="text" value="<?= $postForUpdate->car->cilindrics?>" name="cilindrics" id="input-cilindrics" class="default-input" />
									...
									<div id ="hpDiv">
										...
										<input type="text" value="<?= $postForUpdate->car->hp?>" name="hp" id="input-hp" class="default-input" />
									</div>
									...
									<input type="text" value="<?= $postForUpdate->car->fabrication?>" name="fabrication" id="input-fabrication" class="default-input" />
					...
					<fieldset id="vehicle-equipment" class="checkbox-selection">
						<legend><span class="bold">Choose new</span> equipment</legend>
						<ul class="field-content">
...
<!-- 								/new  -->
					...
					<fieldset id="vehicle-description">
						...
						<div class="field-content" id="descriptDiv">
							...
							<textarea id="vehicle-description-field"  name="description" class="description"><?= $postForUpdate->car->description?></textarea>
						</div>
					</fieldset>
							...
							<li class="select-four">
								...
								<div>
									<label for="select-country-registration">Country of
										...
										<option selected="selected"><?= $postForUpdate->car->countryofregistration?></option>
								...
								<div>
									...
									<select name="year" id="select-registration-year">
										<option selected="selected"><?= $postForUpdate->car->year?></option>
							...
							<li class="select-four">
								<div>
									...
									<select name="condition" id="select-technical-condition">
										<option selected="selected"><?= $postForUpdate->car->technicalcondition?></option>
								...
								<div id="kilometersDiv">
									...
									<input type="text" value="<?= $postForUpdate->car->kilometers?>" name="kilometers" id="input-kilometers" class="default-input" />
								</div>
						...
						<ul class="field-content">
							<li class="select-four">
								<div id="priceDiv">
									...
									<input type="text" value="<?= $postForUpdate->car->fueltype?>" name="price" id="input-price" class="default-input" />
								</div>
								<div>
									<br/>
