...
<div id="page-content">
	...
	<section id="countdown-clock">
		<div class="content-holder">
			...
			<h2>We’ll be here soon with a new website. Estimated time remaining:</h2>
	...
	<section id="newsletter-intro">
		<div class="content-holder">
			<div class="standard-text-content">
				<p class="intro-line">We are building new, beautiful website. In the meantime, while here, you can use the form below to subscribe to our newsletter.</p>
			</div>
